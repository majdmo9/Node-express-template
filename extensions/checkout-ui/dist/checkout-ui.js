...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const handleProductCheck = (id) => {
      ...
      setProducts((prev) => __spreadProps(__spreadValues({}, prev), { [id]: __spreadProps(__spreadValues({}, prev[id]), { checked: !prev[id].checked }) }));
    };
    const handleSave = () => __async(this, null, function* () {
      try {
        const productsList = Object.entries(products).map(
          ([key, value]) => value.checked ? { id: key.split("/")[key.split("/").length - 1], quantity: value.quantity } : ""
        ).filter(Boolean);
        setLoading(true);
        const token = yield sessionToken.get();
        yield fetch(`${extension2.scriptUrl.split("/extensions")[0]}/api/save-cart`, {
          method: "POST",
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { border: "base", borderRadius: "base", padding: "tight", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title: "Save your cart", children: Object.entries(products).map(([key, product]) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Pressable2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { onChange: () => handleProductCheck(key), children: product.title }) }, key)) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        Button2,
        {
          ...
          children: saved ? "Cart Saved" : "Save Cart"
        }
      )
    ] });
  }
